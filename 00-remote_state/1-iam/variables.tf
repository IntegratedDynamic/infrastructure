...
# `permissions_boundary_arn` output of the identity/00-ci-trust/ root. Required by
# the CI grant's conditions.
variable "permissions_boundary_arn" {
  description = "ARN of the permissions boundary to attach (identity/00-ci-trust output)."
  type        = string
